...
#define PWM_B_TIM_GPIO_Pin GPIO_Pin_10
#define PWM_B_TIM_OC_Init(x,y) TIM_OC3Init(x,y)
#define OCB_PreloadConfig(x,y) TIM_OC3PreloadConfig(x,y)
#define OCB_SetCompare(x,y) TIM_SetCompare3(x,y)
#define OCB_PolarityConfig(x,y) TIM_OC3PolarityConfig(x,y)//反转电机时应该设置

//PWM输出控制电机3的GPIO口Pin选、PWM输出通道选择
#define PWM_C_TIM_GPIO_Pin GPIO_Pin_9
#define PWM_C_TIM_OC_Init(x,y) TIM_OC2Init(x,y)
#define OCC_PreloadConfig(x,y) TIM_OC2PreloadConfig(x,y)
#define OCC_SetCompare(x,y) TIM_SetCompare2(x,y)
#define OCC_PolarityConfig(x,y) TIM_OC2PolarityConfig(x,y)//反转电机时应该设置
