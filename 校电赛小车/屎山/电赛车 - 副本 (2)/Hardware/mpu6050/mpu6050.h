...
#define MPU6050_IIC_GPIO_PORT		GPIOB										/* GPIO端口 */
#define MPU6050_IIC_RCC_PORT 		RCC_APB2Periph_GPIOB		/* GPIO端口时钟 */
#define MPU6050_IIC_SCL_PIN		  GPIO_Pin_5							/* 连接到SCL时钟线的GPIO */
#define MPU6050_IIC_SDA_PIN			GPIO_Pin_6							/* 连接到SDA数据线的GPIO */


#define MPU6050_IIC_SCL_1()  GPIO_SetBits(MPU6050_IIC_GPIO_PORT, MPU6050_IIC_SCL_PIN)		/* SCL = 1 */
#define MPU6050_IIC_SCL_0()  GPIO_ResetBits(MPU6050_IIC_GPIO_PORT, MPU6050_IIC_SCL_PIN)	/* SCL = 0 */

#define MPU6050_IIC_SDA_1()  GPIO_SetBits(MPU6050_IIC_GPIO_PORT, MPU6050_IIC_SDA_PIN)		/* SDA = 1 */
#define MPU6050_IIC_SDA_0()  GPIO_ResetBits(MPU6050_IIC_GPIO_PORT, MPU6050_IIC_SDA_PIN)	/* SDA = 0 */

#define MPU6050_IIC_SDA_READ()  GPIO_ReadInputDataBit(MPU6050_IIC_GPIO_PORT, MPU6050_IIC_SDA_PIN)	/* 读SDA口线状态 */
