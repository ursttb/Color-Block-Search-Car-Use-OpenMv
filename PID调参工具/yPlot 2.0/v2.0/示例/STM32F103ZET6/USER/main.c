...
//数据区
float datas[4];//我的波形数据
float cmd_P,cmd_I,cmd_D;//我的PID三个参数

//函数区
void send_wave(void);//自制的发送波形
void getdatas(void);//将要发送的数据防止data[]数组
void get_cmd(void);//得到上位机发来的参数
